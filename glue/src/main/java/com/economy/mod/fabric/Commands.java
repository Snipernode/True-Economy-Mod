...
public final class Commands {
    ...
    public static void run(ServerPlayerEntity player, String[] args) {
        ...
        String owner = PlayerAccess.name(player);
    ...
    // ---- helpers ----
    static void reply(ServerPlayerEntity p, String msg) { p.sendMessage(Text.of(msg), false); }
    static void error(ServerPlayerEntity p, String msg) { p.sendMessage(Text.of("[!] " + msg), false); }
    ...
    private static void help(ServerPlayerEntity p) {
        reply(p, "[True-Economy] /economy <balance|pay|market|auction|bank|shop|events|link>");
    }

    private static void balance(ServerPlayerEntity p, String owner) {
    ...
    private static void pay(ServerPlayerEntity p, String owner, String[] args) {
    ...
    // ---------------- market ----------------
    private static void market(ServerPlayerEntity p, String owner, String[] args) {
    ...
    // ---------------- auction ----------------
    private static void auction(ServerPlayerEntity p, String owner, String[] args) {
    ...
    // ---------------- bank ----------------
    private static void bank(ServerPlayerEntity p, String owner, String[] args) {
    ...
    // ---------------- shop / black market ----------------
    private static void shop(ServerPlayerEntity p, String owner, String identity, String[] args) {
        EconomyCore core = TrueEconomyMod.core();
    ...
    private static void buyBlackMarket(ServerPlayerEntity p, EconomyCore core, String canon, String sectionId, String itemId) {
        for (ShopSection s : core.catalog().all()) {
            ...
            if (!core.economy().getAccount(PlayerAccess.name(p)).withdraw(total)) { error(p, "Insufficient funds."); return; }
    ...
    // ---------------- events ----------------
    private static void events(ServerPlayerEntity p, String[] args) {
        EconomyCore core = TrueEconomyMod.core();
    ...
    // ---------------- link ----------------
    private static void link(ServerPlayerEntity p, String owner, String identity, String[] args) {
